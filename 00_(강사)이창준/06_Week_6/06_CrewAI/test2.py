import os
os.environ["OPENAI_API_KEY"] = "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"
...
researcher = Agent(
                role="연구원",
                goal="""
                    {product}에 대한 가격정보를 종합적으로 파악하여 해석하는 데에 능숙합니다.
                    """,
                backstory="""
                    다양한 웹사이트에서 데이터를 수집하고 해석하는 데에 능숙합니다.
                    각 데이터 소스를 주의 깊게 읽고 가장 중요한 정보를 추출합니다.
                    당신의 통찰력은 구매 결정에 중요합니다.
                    """,
                verbose=True,
...
manager = Agent(
                role="매니저",
                goal="""
                    가성비가 가장 높은 제품을 찾아내고 구매하는 데에 능숙합니다.
                    
                    """,
                backstory="""
                    당신은 수익성 있는 투자를 하는 데 있어 검증된 성적표를 가진 경험 많은 헤지펀드 매니저입니다.
                    항상 구매티에게 감동을 주고 있습니다.
                    """,
                verbose=True,
                output_file="_manager_Agent.md",
            )
