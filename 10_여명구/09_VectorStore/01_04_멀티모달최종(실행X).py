...
# pip install -qU open-clip-torch langchain_experimental langchain_teddynote langchain_openai matplotlib chromadb
...
# Step 9: Create Vectorstore and Add Images
print("[INFO] Creating Vectorstore and adding images...")
image_db = Chroma(
...
# Step 10: Implement ImageRetriever Class
print("[INFO] Setting up ImageRetriever...")
class ImageRetriever:
    ...
    def resize_base64_image(base64_string, size=(224, 224)):
        ...
        Args:
        base64_string (str): Base64 encoded string of the original image.
    ...
    def plt_img_base64(img_base64):
        """
        Display an image encoded as Base64.

        Args:
        img_base64 (str): Base64 encoded string of the image.
        """
        image_html = f'<img src="data:image/jpeg;base64,{img_base64}" />'
        display(HTML(image_html))

# Step 11: Create ImageRetriever Instance and Query Images
retriever = image_db.as_retriever(search_kwargs={"k": 3})
image_retriever = ImageRetriever(retriever)

print("[INFO] Querying images...")
result = image_retriever.invoke("A Dog on the street")

# 터미널에 검색 결과 출력
print("[RESULT] Retrieved Documents:")
